...
final class SeleniumActionFacade {
    ...
    final PublicMenuAction hamburgermenu;
    final InternalMenuAction interniMenu;
    final LoginAction prihlasovani;
    final OrderAction sekceObjednavky;
    final ApplicationAction sekceOurRooms;
    final ApplicationDetail roomDetail;
    ...
    public SeleniumActionFacade(WebDriver driver) {
        ...
        this.hamburgermenu = new PublicMenuAction(elementFinder);
        ...
        this.sekceOurRooms = new ApplicationAction(elementFinder);
        this.roomDetail = new ApplicationDetail(elementFinder);
